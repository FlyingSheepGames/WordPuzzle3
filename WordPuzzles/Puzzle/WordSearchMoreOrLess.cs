...
(This is only an example, and does not apply to the grid below.)<p>
The word may be placed in the grid horizontally, vertically, diagonally, and may be read backwards. It will not wrap around the edge of the grid.<p>
