    ...
    class Program
    {
        ...
        static void Main()
        {
            ...
            */
            ...
            switch (programMode)
            {
                case ProgramMode.COLLECTION:
                    RunInCollectionMode();
                    break;
                case ProgramMode.PATTERN_MATCH:
                    InteractivelyCreatesWordsWithSelectedPattern();
                    break;
                case ProgramMode.YEAR:
                    RunInYearMode();
                    break;
        ...
        private static void InteractivelyCreatesWordsWithSelectedPattern()
        {
